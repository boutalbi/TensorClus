...
setup(name='TensorClus',
      ...
      setup_requires=["numpy==1.19.2", 'scipy', 'scikit-learn','matplotlib', 'coclust','tensorly','tensorflow'],
      install_requires=[
          'numpy==1.19.2', 'scipy', 'scikit-learn','matplotlib', 'coclust','tensorly','tensorflow'
      ],
      extras_require={
        'alldeps': (
            'numpy==1.19.2',
