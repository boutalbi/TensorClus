...
setup(name='TensorClus',
      ...
      setup_requires=['pip>=19.0',"numpy==1.17.4",'pandas==0.23.4', 'scipy', 'scikit-learn==0.22.1','matplotlib', 'coclust'],
      install_requires=[
          'pip>=19.0','numpy==1.17.4','pandas==0.23.4', 'scipy', 'scikit-learn==0.22.1','matplotlib', 'coclust'
      ],
      extras_require={
        'alldeps': (
            'numpy==1.17.4',
