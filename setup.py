...
setup(name='TensorClus',
      ...
      setup_requires=['pip>=19.0',"numpy==1.16.1",'pandas==1.0.3', 'scipy==1.2.1', 'scikit-learn==0.22.1','matplotlib', 'coclust'],
      install_requires=[
          'pip>=19.0','numpy==1.16.1','pandas==1.0.3', 'scipy==1.2.1', 'scikit-learn==0.22.1','matplotlib', 'coclust'
      ],
      extras_require={
        'alldeps': (
            'numpy==1.16.1',
